...
% Set up workspace variables.   
    ...
    helpString = ['First select a text file to send. '...
        'If you want to save an audio .wav file of the sent '...
        'data, check the save audio file check box below. '...
        'When you exit you will have the option of saving '...
...
%% CloseRequestCallback -------------------------------------------
    ...
    % Close Flasher window if enabled
     ...
     % Save the audio file if it was generated
        if charCount > 0 && saveAudioFile == 1
            startDirectory = cd;           
            [fileNameWithTag, fileDirectory] = uiputfile({'*.wav'},...
            'Save the audio file',...
            [startDirectory  '\UserData\' userName '\' baseFileName]);
            if fileDirectory ~= 0
