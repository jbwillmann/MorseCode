...
% Set up workspace variables.
    ...
    sentString = [];
    saveTextFile = 0;
    helpString = ['Use the Select Mode button below to '...
    'change the mode to include numbers, puncuation or '...
    'synbols; to change from sequentioa or randon; or to '...
    'break the transmission onto groups. '...
    'The Start Transmission below will begin the process '...
    'which can then be pauses and restarted. '...
    'Select Save text file on exit below to save a copy of the '...
