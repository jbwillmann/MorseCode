...
% This function is called when the user selects Colors on the      
% Program Preferences window. This window opens and the user can edit 
% the colors of the programs windows and windows elements.
...
% Set up Application title
    uicontrol('Style', 'text',...
        ...
        'string','Color Preferences Management'...
        ); 
...
% Save the new colors
    function ChangeColorCallback(~,~,num)
        switch num
            ...
            case 4  % Textbox Color 
                selectedColor = uisetcolor(glob.boxColor,...
                    'Select an Textbox Color');
                set(ControlTextboxColorHandle,...
                'BackgroundColor',selectedColor);
                glob.boxColor = selectedColor;
            case 5  % Transmit Background Color
                selectedColor = uisetcolor(glob.xmitBackgroundColor,...
